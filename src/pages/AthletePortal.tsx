...
const AthletePortal = () => {
  ...
  return (
    <div className="min-h-screen bg-[#05070A] text-white font-sans selection:bg-[#3B82F6] selection:text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-6 sm:pt-10 pb-20 lg:pt-20">
        <nav className="flex items-center justify-between mb-12 sm:mb-24">
          <Link to="/" className="flex items-center gap-2 sm:gap-3 group shrink-0">
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#3B82F6] rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg group-hover:rotate-12 transition-transform shadow-blue-500/20">
            ...
            <span className="text-base sm:text-xl font-display font-black italic tracking-tighter uppercase whitespace-nowrap">
              Run<span className="text-[#3B82F6]">Manager</span> <span className="hidden sm:inline-block text-[10px] ml-1 bg-white/10 px-2 py-0.5 rounded text-slate-400 not-italic font-black tracking-widest uppercase">Atleta</span>
            </span>
          </Link>
          ...
          {user ? (
            <Link 
              ...
              className="bg-[#3B82F6] text-white px-6 py-2.5 rounded-xl font-black text-xs uppercase tracking-widest italic shadow-xl hover:bg-blue-400 transition-colors shadow-blue-500/10"
            >
              Visão Geral
            </Link>
          ) : (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="space-y-4 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-[#3B82F6] text-[8px] sm:text-[10px] font-black uppercase tracking-[0.3em] italic mb-2 sm:mb-4">
              ...
              <h1 className="text-4xl sm:text-7xl lg:text-8xl font-display font-black italic uppercase tracking-tighter leading-[0.9]">
                Sua Melhor <br/>
                <span className="text-[#3B82F6] text-stroke">Versão</span> <br/>
                Começa <span className="text-[#3B82F6] italic">Aqui.</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <Link 
                to="/register"
                className="group relative bg-[#3B82F6] text-white px-10 py-5 rounded-[2rem] font-black italic uppercase text-sm tracking-widest shadow-[0_20px_40px_-5px_rgba(59,130,246,0.4)] flex items-center justify-center gap-3 overflow-hidden transition-all hover:scale-105 active:scale-95"
              >
            ...
            <div className="grid grid-cols-3 gap-8 pt-10 border-t border-white/5">
              <div>
                <div className="text-3xl font-display font-black italic text-[#3B82F6] mb-1">24/7</div>
                <div className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Acesso Vitalício</div>
              </div>
              <div>
                <div className="text-3xl font-display font-black italic text-[#3B82F6] mb-1">HD</div>
                <div className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Vídeos 4K</div>
              </div>
              <div>
                <div className="text-3xl font-display font-black italic text-[#3B82F6] mb-1">PRO</div>
               ...
               <div className="absolute inset-0 bg-gradient-to-br from-slate-900 to-black p-10 flex flex-col justify-between">
                  ...
                  <div className="space-y-6">
                     ...
                     <div className="h-32 w-full bg-white/5 rounded-[2rem] border border-white/10 flex items-center justify-center">
                        <Zap className="w-8 h-8 text-[#3B82F6] animate-bounce" />
                     </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                     <div className="h-12 bg-blue-500/10 rounded-2xl border border-blue-500/20" />
